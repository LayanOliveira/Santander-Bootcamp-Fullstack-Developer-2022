function comparaNumero(num1, num2) {
    ...
    try {
        if (num1 == null || num2 == null) { return "Entre dois números" }
        if (typeof num1 !== 'number' && typeof !num2 !== 'number') throw new TypeError('Entre DOIS "NÚMEROS"')
        if (!num1 || !num2) throw new ReferenceError("Parâmetro Inválido")
